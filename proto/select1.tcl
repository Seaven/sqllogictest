...
puts {statement ok}
puts {Drop table IF EXISTS t1}
puts {}

puts {statement ok}
puts {CREATE TABLE t1(a INTEGER, b INTEGER, c INTEGER, d INTEGER, e INTEGER) DUPLICATE KEY(`a`) DISTRIBUTED BY HASH(a) BUCKETS 10 PROPERTIES ("replication_num" = "1")}
puts {}
